const page = () => {
  return (
    <div>
      ...
      <p>
        Autobay (“Autobay”, “we”, “us”, or “our”) is a React application that integrates with the eBay Developer Program API. This Privacy Policy explains what
        data we collect, how we use it, how we share it, and your rights.
      </p>

      <h2>Information We Collect</h2>
      <ul>
        <li>Account &amp; Authentication: eBay User ID, OAuth tokens/refresh tokens, token metadata (scope, expiration).</li>
        <li>eBay Data You Authorize: listings, orders, inventory, shipping details, and related operational data strictly within granted scopes.</li>
        <li>Technical &amp; Usage Logs: API request/response metadata (timestamps, endpoints), device/browser information, IP, and error logs.</li>
        <li>Support Communications: email and message content you send to us.</li>
      </ul>
      ...
      <ul>
        ...
        <li>Service Providers: hosting, storage, logging, and operational support under confidentiality and data protection terms.</li>
        <li>Compliance &amp; Safety: if required by law or to protect rights, security, or integrity of our services.</li>
      </ul>
      <p>We do not sell your personal information.</p>

      <h2>International Transfers</h2>
      <p>If data is transferred across borders, we use appropriate safeguards such as standard contractual clauses or equivalent mechanisms.</p>

      <h2>Retention</h2>
      <ul>
        <li>OAuth tokens: stored securely and retained only while your account remains connected.</li>
        <li>eBay operational data: cached or stored only as necessary for features you use and then deleted or anonymized.</li>
      ...
      <p>
        We may update this Privacy Policy. The “Effective Date” above reflects the latest version. Material changes will be communicated within the app or by
      ...
      <h2>Controller</h2>
      <p>
        For users in the EEA/UK, Autobay is the data controller for processing described here. Where we process eBay data on your behalf to operate your account
        workflows, we act as a processor to the extent applicable.
      </p>
