        ...
        <nav className="hidden justify-between lg:flex">
          <div className="flex items-center gap-6">
            ...
            <a className="flex items-center gap-2" href={logo.url}>
              ...
              <span className="font-semibold text-lg tracking-tighter">{logo.title}</span>
            </a>
            ...
            <Sheet>
              ...
              <SheetContent className="overflow-y-auto">
                ...
                <div className="flex flex-col gap-6 p-4">
                  <Accordion className="flex w-full flex-col gap-4" collapsible type="single">
  ...
  if (item.items) {
    return (
      <AccordionItem className="border-b-0" key={item.title} value={item.title}>
        <AccordionTrigger className="py-0 font-semibold text-md hover:no-underline">{item.title}</AccordionTrigger>
