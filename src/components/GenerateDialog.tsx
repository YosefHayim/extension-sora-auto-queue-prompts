...
export function GenerateDialog({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      log.ui.action("GenerateDialog:Submit", {
        count,
      ...
      >
              ...
              <div className="flex items-center gap-2 flex-wrap">
                {detectedSettings.mediaType && (
                  <Badge variant="outline" className="gap-1 text-xs">
                    ...
                    {detectedSettings.mediaType.charAt(0).toUpperCase() +
                      detectedSettings.mediaType.slice(1)}
                  </Badge>
                )}
                {detectedSettings.aspectRatio && (
                  <Badge variant="outline" className="gap-1 text-xs">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">
              Describe the theme or style for generated prompts
            </p>
          </div>
          ...
          {loading && progress.total > 0 && (
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground text-center">
                {progress.current} prompt{progress.current !== 1 ? "s" : ""}{" "}
