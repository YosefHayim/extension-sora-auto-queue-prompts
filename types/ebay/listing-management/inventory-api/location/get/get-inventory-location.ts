import type { Address, DayOfWeekEnum, GeoCoordinates, StatusEnum, StoreTypeEnum } from "../post/create-inventory-location";
 ...
 */
export declare function getInventoryLocation(request: GetInventoryLocationRequest, options: GetInventoryLocationOptions): Promise<GetInventoryLocationResponse>;
