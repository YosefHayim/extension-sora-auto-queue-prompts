 ...
 */
export declare function getInventoryLocations(query: GetInventoryLocationsQuery, options: GetInventoryLocationsOptions): Promise<GetInventoryLocationsResponse>;
