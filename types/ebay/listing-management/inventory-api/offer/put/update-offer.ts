...
import type { Charity, ErrorParameterV3, ExtendedProducerResponsibility, ListingPolicies, PricingSummary, Regulatory } from "../post/bulk-create-offer";
 ...
 */
export declare function updateOffer(offerId: string, body: UpdateOfferRequest, options: UpdateOfferOptions): Promise<UpdateOfferResponse>;
